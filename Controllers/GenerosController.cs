...
namespace TareaSemana4._2_MiguelOsorio_21551109.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        public GenerosController(DMVDataContext context)
        {
            ...
            {
                _context.Generos.Add(new Genero { NombreGenero = "Genero1" });
                _context.Generos.Add(new Genero { NombreGenero = "Genero2" });
                _context.Generos.Add(new Genero { NombreGenero = "Genero3" });
        ...
        {
            return await _context.Generos.Include(q => q.Canciones).ToListAsync();
        }
        ...
        {
            var genero = await _context.Generos.Include(q => q.Canciones).FirstOrDefaultAsync(q => q.IdGenero == id);
